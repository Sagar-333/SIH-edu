    ...
    <div className="container__register">
      <div className="register__row">
        <div className="register__col">
          <div className="register__col__1">
            <img src={Saly1} alt="Registration illustration" />
          </div>
        </div>
        <div className="register__col">
          <div className="register__col__2">
            ...
            <form>
              ...
              <div className="checkbox">
                ...
                <label htmlFor="checkbox">I agree with all of your
                  <span><a href="#">Terms of Services</a></span></label>
                <input id="submit" type="submit" value="Create Account →" />
              </div>
              <br />
              <div className="signup-section">
                <hr className="signup-line" />
                <span className="signup-text">SIGNUP WITH</span>
                <hr className="signup-line" />
              </div>
